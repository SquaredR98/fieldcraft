...
export function useFormEngine(
  ...
  const proxy = useMemo<FormEngine>(
    () => ({
      ...
      getVisibleQuestions: () => engine.getVisibleQuestions(),
      ...
      resetField: (id) => engine.resetField(id),
      resetForm: () => engine.resetForm(),
      getFieldState: (id) => engine.getFieldState(id),
      getChangedFields: () => engine.getChangedFields(),
      focusField: (id) => engine.focusField(id),
      isFieldReadonly: (id) => engine.isFieldReadonly(id),
