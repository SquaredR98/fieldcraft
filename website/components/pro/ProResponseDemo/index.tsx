...
const mockResponses: FormResponse[] = [
  ...
  { schemaId: 'demo-feedback', schemaVersion: '1', submittedAt: '2026-08-14T14:47:00Z', sessionToken: 'sess-002', values: { name: 'Marcus Rivera', email: 'marcus@clinic.io', rating: 10, category: 'feature', message: 'The telehealth instruments are exactly what we needed for our EHR. PHQ-9 scoring is spot on.', subscribe: true } },
