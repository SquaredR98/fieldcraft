...
description: Register your own field components alongside the 42 built-ins using the field registry.
---

## The field registry

Every field type maps to a React component via the registry. The default registry contains all 42 built-in field components. You can add your own types or override existing ones.
...
- [Field types](/docs/core-concepts/field-types) — the 42 built-in types for reference
