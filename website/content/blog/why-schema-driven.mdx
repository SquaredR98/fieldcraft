...
| **React Renderer** | `@squaredr/fieldcraft-react` | Renders 42 field types, manages focus and keyboard nav, displays errors and progress |
...
The engine supports 42 field types out of the box. For the remaining edge cases, you can register custom field types through the field registry and they'll work with all the same validation, conditional logic, and persistence features.
