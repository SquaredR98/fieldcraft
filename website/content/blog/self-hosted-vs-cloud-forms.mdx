...
FieldCraft is an open-source (MIT) schema-driven form engine. It ships 44 field types, conditional logic with 25 operators, multi-step navigation, validation pipeline, draft persistence, and theming — all rendered as native React components.
