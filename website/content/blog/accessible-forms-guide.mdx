...
- [Field types](/docs/core-concepts/field-types) — all 41 field types with their accessibility attributes
- [Conditional logic](/docs/core-concepts/conditional-logic) — how `showIf` interacts with ARIA live regions
- [Building Accessible Forms: Schema anatomy](/docs/core-concepts/schema-anatomy) — the full JSON schema reference
