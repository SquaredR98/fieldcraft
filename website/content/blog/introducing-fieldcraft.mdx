...
> **TL;DR** — FieldCraft is a schema-driven form engine for React. Define your form as JSON, get validation, conditional logic, multi-step flows, draft persistence, and 42 field types — without writing form state code.
