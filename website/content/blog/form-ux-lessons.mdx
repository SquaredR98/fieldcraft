...
date: "2026-05-17"
description: "After building 41 field types and hundreds of test forms, these are the UX decisions that actually moved completion rates."
category: "Patterns"
...
I tried showing errors on submit-only (no inline feedback). Completion rates dropped. People would fill out 15 fields, hit submit, see 4 errors, and leave. On-blur validation catches mistakes early without being hostile.
...
Yes, it looks like more red on the screen. But it's honest. Users fix everything once instead of playing whack-a-mole with validation messages. My test forms saw fewer round-trips between field and submit button when all errors were visible.
...
One important detail: drafts need an expiration. A 6-month-old draft of a form that's since been redesigned will cause confusing validation errors. I default to 72 hours. Long enough to survive a weekend, short enough to avoid stale data.
...
- [Validation docs](/docs/core-concepts/validation) — the 27 built-in validators and when they trigger
