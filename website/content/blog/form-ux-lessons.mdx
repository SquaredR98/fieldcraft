...
*FieldCraft ships with all six of these patterns built in. Check the [templates on npm](https://www.npmjs.com/package/@squaredr/fieldcraft-templates-free) to see them in action, or read the [docs](/docs) to build your first form.*
