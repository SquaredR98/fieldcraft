...
| `@squaredr/fieldcraft-react` | [npm](https://www.npmjs.com/package/@squaredr/fieldcraft-react) | 1.7.0 | React renderer. 44 field components. 3 display modes. shadcn/ui + Tailwind. |
